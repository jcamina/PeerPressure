...
public class FLeaderboardSplashTieActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fleaderboard_splash_tie);
        ...
        if (v == mainMenuButton){
            ...
            lobbyRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    Intent FLeaderBoardToJoinCreate = new Intent(FLeaderboardSplashTieActivity.this,JoinCreateGameActivity.class);
