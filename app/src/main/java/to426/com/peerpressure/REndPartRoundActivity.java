        ...
        currentLobby.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    /*
                    if (currentProperties.equals("Round 1")) {

                        if (currentProperties.getDareRoundRandomized() && !currentProperties.getRoundOneComplete()){
                        ...
                        } else if (currentProperties.getRoundOneComplete()) {
                    ...
                    } else if (currentProperties.equals("Round 2")) {
                        if (currentProperties.getDareRoundRandomized() && !currentProperties.getRoundTwoComplete()){
                        ...
                        } else if (currentProperties.getRoundTwoComplete()) {
